...
exports.SERVER_DIRECTORY_PATH = path.join(exports.SHELF_ROOT_DIRECTORY_PATH, "server");
...
exports.CLIENT_DIRECTORY_PATH = path.join(exports.SHELF_ROOT_DIRECTORY_PATH, "client");
